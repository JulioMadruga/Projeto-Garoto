...
$jum = $result_cont[0][4];
 ...
 $consulta_baton= $conn->prepare("select b.VENDEDOR,a.Nome_parceiro, a.id from $mes a, $meta b where a.Material in ($jum) and a.VENDEDOR = b.rca and a.VENDEDOR = '$vendedor' and a.Quantidade>0 GROUP BY a.id");
