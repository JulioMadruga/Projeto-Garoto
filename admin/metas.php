...
if ($vendedor == "" or $mes == "" ){
 ...
 echo "<script>alert('Selecione um Vendedor e um Mês!!!')</script>";
      ...
      $tabletes = "'12260896','12285329','12285325','12285279','12285326','12285324','12285327','12285328','12282660'";
      $sortido = "'12280901'";
    ...
    <body style="background: #737373">
         <div id="nav" class="col-lg-12"  style="background: #121415;">
             <ul class="nav">
                 ...
                 <li role="presentation"  id="active"><a href="#">Metas</a></li>
...
?>
    ...
    <select name="select_mes">
     ...
     <option value="meta' . $i . '"';
      ...
      <input name="enviar" type="submit" class="btn-info" value="Consultar" />         
       ...
       <div class="col-md-2"></div> 
       <div class="col-md-6" style="background-color: aliceblue; padding-top: 70px; height: 600px">   
 ...
 //============================== CandyBar ==========================
  ...
  if (count($result_kg) ) {
    ...
    //var_dump($row);
                 do {  
       echo "<tr class='success' style='background-color: rgba(141, 202, 220, 0.77); color: #0D1B05; font-size: 16px;font-weight: bold; border: solid; border-color: #245269;'> ";
  ...
  if (count($result_valor) ) {
    ...
    //var_dump($row);
       ...
       echo "<td style='width: 300px; text-align: center; font-weight: bold;'>Total em R$</td>";
       if ($row[1]==null){
 ...
 ?>
   ...
   <div class="col-md-2" Style="background: aliceblue; height: 600px;">
    ...
    <table align="center" cellpadding="5" style="border: solid;">
           <tr style="background-color: #1b6d85; color: #ffffff; font-weight: bold">
               ...
               <td style="text-align: center;border: solid; font-size: 12px;  border-color: #245269;">Resultado Trimarca </td>
    ...
    foreach($result_tri as $row) {
      ...
      echo "</tr>"; 
       ...
       echo "</tr>";
           ...
           <table  align="center" cellpadding="5">
               <tr><td style="padding-top: 8px;"colspan="3"></td></tr>
