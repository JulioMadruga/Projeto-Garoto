                  ...
                  <ul class="nav">
                      ...
                      <li class="button-dropdown"><a href="javascript:void(0)" class="dropdown-toggle">Importacao<span>▼</span>  </a>
                          <ul class="dropdown-menu">
                              ...
                              <li role="presentation" id="active"><a href="#">Produtos</a></li>
...
if (isset($_POST['submit'])) {    
   ...
   $deleterecords = "TRUNCATE TABLE produtos" ;//Esvaziar a tabela
   ...
   //Importar o arquivo transferido para o banco de dados
    while (($dados = fgetcsv($handle, 1000, ";"))!== FALSE ) {
        ...
        $import= $conn->prepare("INSERT INTO produtos (cod_prod,descricao,emb,QT_CX) Values ('$dados[0]','$dados[1]','$dados[2]','$dados[3]')");
        var_dump($import);
        $import->execute();
