...
window.onload = function(){
    ...
    <div class="row" style="padding-top: 115px;">
       ...
       <select id="mes" name="mes"style="height: 60px; background-color: #0C4F63;color: #ffffff; font-family: sans-serif; width: 200px; font-size: 25px;text-align: center; font-weight: bold;" > 
...
<div class="col-md-12" style=" background: #ff1d09; height: 150px; padding-top: 10px;">    
<table align="center" cellpadding="5"> 
           <tr style="background-color: #84071D; color: #FFFFFF; font-weight: bold; font-family:Dosis; " >
               <td colspan="4" style="text-align: center; font-size: 25px;background: #FF2012;"><img style="width:270px" src="images/baton2.png"></td>
           </tr>
</table>
           </div>
...
<div class="col-md-12" style="text-align:center; padding-top: 20px; background-color:#CED4D6; font-family:Oswald; color:#270301;">
<table id="tabela" align="center" cellpadding="5" style="color:#0F4150; font-size: 40px; width: 100%">


<tr style="background: #095409;color: aliceblue; "> 
<td style="width: 18%; text-align: center; border: solid; border-color: #CED4D6;border-right-color: aliceblue;">Cod. Cliente</td>
<td style="width: 60%; text-align: center; border: solid; border-color: #CED4D6;border-right-color: aliceblue;">Razão Social</td>
<td style="width: 22%; text-align: center; border: solid; border-color: #CED4D6;border-right-color: aliceblue;">Status</td>
       ...
       if (count($result_cli) ) {
           ...
           foreach($result_cli as $row) {
               ...
               foreach ($result_baton as $row2){
                   ...
                   if($row[1] == $row2[0]){
                       echo '<tr class="success" style="background: #5cb85c;">';
                       echo'<td id="vendedor"style="width: 18%; text-align: center; border: solid; border-color: #CED4D6;">'.$row[1].'</td>';
                       echo '<td style="width: 60%; text-align: center; border: solid; border-color: #CED4D6;">'.$row[2].'</td>';
                       echo '<td style="width: 22%; text-align: center; border: solid; border-color: #CED4D6;">Positivado</td>';
                       $verfic = false;
...
<table id="tabela" align="center" cellpadding="5" style="color:#0F4150; width: 100%; font-size: 40px;">
  
<tr style="background: #860c0a;color: aliceblue;"> 
<td style="width: 18%; text-align: center; border: solid; border-color: #CED4D6;border-right-color: aliceblue;">Cod. Cliente</td>
<td style="width: 60%; text-align: center; border: solid; border-color: #CED4D6;border-right-color: aliceblue;">Razão Social</td>
<td style="width: 22%; text-align: center; border: solid; border-color: #CED4D6;border-right-color: aliceblue;">Status</td>
...
';
       ...
       if (count($result_positivar) ) {
           ...
           foreach($result_positivar as $row) {
               ...
               echo '<tr class="success" style="background: #b7afaf; color: #9c1c1c;">';
               echo '<td id="vendedor"style="width: 18%; text-align: center; border: solid; border-color: #CED4D6;">' . $row[1] . '</td>';
               echo '<td style="width: 60%; text-align: center; border: solid; border-color: #CED4D6;">' . $row[2] . '</td>';
               echo '<td style="width: 22%; text-align: center; border: solid; border-color: #CED4D6;"></td>';
