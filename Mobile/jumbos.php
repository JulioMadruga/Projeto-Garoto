...
$jum = $result_cont[0][4];
 ...
 $consulta_baton= $conn->prepare("select a.id, b.VENDEDOR,a.Nome_parceiro from $mes a, $meta b where a.Material in ($jum) and a.VENDEDOR = b.rca and a.VENDEDOR = '$vendedor' and a.Quantidade>0 GROUP BY a.id");
 ...
 $consulta_TOTAL= $conn->prepare("SELECT Vendedor,Cod_Cliente, Nome from clientes WHERE Cod_Cliente NOT IN 
(select id from (SELECT a.VENDEDOR, a.ID, b.Nome,a.MATERIAL IN ($jum)AS baton, a.Quantidade 
FROM $mes a, clientes b where a.vendedor = b.rca AND a.ID=b.Cod_Cliente and a.MATERIAL IN ($jum) 
        ...
        <div id="menuToggle">
           ...
           Algumas ações do menu.
            ...
            <ul id="menu_mob">
                ...
                <li role="presentation" class="active"><a href="#">Post. Jumbos</a></li>
...
<h2 style="text-align:center;"class="btn btn-default btn-lg link2"><a style="padding:6px;"href="jumbos.php">Voltar</a><h2>
</div>
