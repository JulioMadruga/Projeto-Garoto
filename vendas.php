 ...
 //var_dump($result3);
  ...
  if (count($result) ) {
    ...
    foreach($result as $row) {
       ...
       echo "<td id='vendedor".$i."' style='width: 100px; '>{$VENDEDOR}";
       echo "<td class='link' id='parceiro".$i."'style='width: 300px;'><a id href='?nota={$n_nf}&mes=$meta'>$row[0]</a></td>"; 
       echo "<td class='link' id='nf".$i."'style='width: 100px; text-align: center;'><a href='?nota={$n_nf}&mes=$meta'>{$n_nf}</a></td>";
